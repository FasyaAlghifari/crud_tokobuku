										...
										<form method="POST" action="update.php" enctype="multipart/form-data">
											...
											<div class="row">
												<div class="form-floating mb-3 col">
													<input type="text" name="pengarang"  placeholder="Pengarang" value="<?php echo $d['pengarang']; ?>" class="form-control">
													<label for="pengarang" style="margin-left:12px">Pengarang</label>
												</div>
                                            ...
                                            <div class="form-floating mb-3 col">
													<input type="text" name="harga" id="harga"  placeholder="Harga" value="<?php echo $d['harga']; ?>" class="form-control">
