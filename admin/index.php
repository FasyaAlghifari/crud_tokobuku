                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="../user/tabel_transaksi.php">Tabel Transaksi</a>
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        ...
                        $data_admin = mysqli_query($koneksi, "SELECT * FROM login where level = 'user'");
                                ...
                                <tbody>
                                    ...
                                    while ($d = mysqli_fetch_array($data)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_buku.php?id_buku=<?php echo $d['id_buku']; ?>" name="id_user"
                                                    class="btn btn-outline-success" style="width: 77px;">EDIT</a>
                                                <a href="hapus_buku.php?id_buku=<?php echo $d['id_buku']; ?>"
