                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="tabel_transaksi.php">Tabel Transaksi</a>
                            </nav>
                        </div>
                    </div>
                </div>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        ...
                        $data_user = mysqli_query($koneksi, "SELECT * FROM login where level = 'user' ");
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="transaksi.php?id_buku=<?php echo $d['id_buku']; ?>" class="btn btn-outline-success">Beli</a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
